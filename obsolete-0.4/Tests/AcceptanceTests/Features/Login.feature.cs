...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Login", "In order to browse protected sites\nAs member of the site\nI want to be able to log" +
                    " into the page", GenerationTargetLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("NoUserNameEntered", ((string[])(null)));
#line 12
this.ScenarioSetup(scenarioInfo);
#line 13
 testRunner.Given("I navigate to \"/Account/Logon\"");
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("NoPasswordEntered", ((string[])(null)));
#line 18
this.ScenarioSetup(scenarioInfo);
#line 19
 testRunner.Given("I navigate to \"/Account/Logon\"");
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("ShortUserNameEntered", ((string[])(null)));
#line 24
this.ScenarioSetup(scenarioInfo);
#line 25
 testRunner.Given("I navigate to \"/Account/Logon\"");
...
#line 27
 testRunner.When("I press \"loginButton\"");
#line 28
 testRunner.Then("I see an error message telling me \"The field Username must be a string with a min" +
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("ShortPasswordEntered", ((string[])(null)));
#line 30
this.ScenarioSetup(scenarioInfo);
#line 31
 testRunner.Given("I navigate to \"/Account/Logon\"");
...
#line 33
 testRunner.When("I press \"loginButton\"");
#line 34
 testRunner.Then("I see an error message telling me \"The field Password must be a string with a min" +
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("LongUserNameEntered", ((string[])(null)));
#line 36
this.ScenarioSetup(scenarioInfo);
#line 37
 testRunner.Given("I navigate to \"/Account/Logon\"");
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("LongPasswordEntered", ((string[])(null)));
#line 42
this.ScenarioSetup(scenarioInfo);
#line 43
 testRunner.Given("I navigate to \"/Account/Logon\"");
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("UsernameAndPasswordDoNotMatch")]
        public virtual void UsernameAndPasswordDoNotMatch()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("UsernameAndPasswordDoNotMatch", ((string[])(null)));
#line 48
this.ScenarioSetup(scenarioInfo);
#line 49
 testRunner.Given("I navigate to \"/Account/Logon\"");
#line 50
 testRunner.And("I have entered \"testuser\" as username and \"wrongPwd\" as password");
#line 51
 testRunner.When("I press \"loginButton\"");
#line 52
 testRunner.Then("I see an error message telling me \"Wrong username or password\"");
#line hidden
            testRunner.CollectScenarioErrors();
        }
    }
