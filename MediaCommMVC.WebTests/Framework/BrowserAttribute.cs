...
namespace MediaCommMVC.WebTests.Framework
{
    /// <summary>
    ...
    [AttributeUsage(PatternAttributeTargets.TestMethod | PatternAttributeTargets.Test, AllowMultiple = true, Inherited = true)]
