...
namespace MediaCommMVC.UI.Infrastructure
{
    ...
    public class HttpContextLifetimeManager<T> : LifetimeManager, IDisposable
    {
        ...
        /// <summary>Gets the value from the current HttpContext.</summary>
        ...
        /// <summary>Removes the value from the current HttpContext.</summary>
        public override void RemoveValue()
        {
            HttpContext.Current.Items.Remove(typeof(T).AssemblyQualifiedName);
        }

        /// <summary>Sets the value in the current HttpContext.</summary>
        ...
        /// <summary>Removes the item from the HttpContext.</summary>
        public void Dispose()
        {
            this.RemoveValue();
        }
