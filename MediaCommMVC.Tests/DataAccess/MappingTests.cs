    ...
    public class MappingTests
    {
        ...
        public void CanMapPost()
        {
            new PersistenceSpecification<Post>(this.sessionManager.Session)
                ...
                .CheckProperty(p => p.Topic, new Topic { Title = "my topic", Created = DateTime.Today, CreatedBy = "some poster", Forum = new Forum { Title = "my post's forum" }, LastPostTime = DateTime.Today })
                .VerifyTheMappings();
        }
    }
}
